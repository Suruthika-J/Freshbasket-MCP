...
// Location sub-schema for tracking
...
const orderSchema = new mongoose.Schema({
    ...
    deliveryLocation: locationSchema, // Customer location (geocoded from address)
    agentLocation: locationSchema, // Current agent location (updated in real-time)
    trackingEnabled: {
        type: Boolean,
        default: false
    },
